...
const translations = {
  ...
  "AIWA Electronics International Co., Ltd. manages brand licensing, partner cooperation, OEM/ODM coordination, and product approval for AIWA markets outside Japan and Korea.": "AIWA Electronics International Co., Ltd. 負責日本與韓國以外市場的品牌授權、夥伴合作、OEM／ODM 協調與產品核准。",
  ...
  "The site positions AIWA Electronics International Co., Ltd. as the authority that defines licensing scope, evaluates manufacturing routes, coordinates partner cooperation, and protects AIWA brand standards before products enter the market.": "本網站呈現 AIWA Electronics International Co., Ltd. 的總部角色：定義授權範圍、評估製造路徑、協調夥伴合作，並在產品進入市場前守護 AIWA 品牌標準。",
  ...
  "OEM/ODM Coordination": "OEM／ODM 協調",
  "Partners may propose factories or work with qualified manufacturing resources introduced through AIWA Electronics International Co., Ltd.": "合作夥伴可提出自有工廠，或與 AIWA Electronics International Co., Ltd. 引介的合格製造資源合作。",
  ...
  "Factory Route": "工廠路徑",
  "Partner-owned factory or approved OEM/ODM resource discussion.": "討論合作夥伴自有工廠，或合格 OEM／ODM 製造資源。",
  "Shipment": "出貨",
  ...
  "Factory proposal, OEM/ODM option, production capability discussion.": "工廠提案、OEM／ODM 選項與生產能力討論。",
  ...
  "Flexible manufacturing paths, controlled by brand standards.": "彈性的製造路徑，由品牌標準掌握品質。",
  "OEM/ODM Cooperation": "OEM／ODM 合作",
  "The cooperation model allows authorized partners to bring their own factories or discuss existing manufacturing resources with AIWA Electronics International Co., Ltd. The key is not who owns the factory relationship, but whether the final product meets the brand standard.": "此合作模式允許獲授權夥伴提出自有工廠，或與 AIWA Electronics International Co., Ltd. 討論既有製造資源。關鍵不在於工廠關係由誰擁有，而在於最終產品是否符合品牌標準。",
  ...
  "We want to discuss AIWA-approved OEM/ODM resources": "我們希望討論 AIWA 核准的 OEM／ODM 資源",
  ...
  "OEM/ODM Fit": "OEM／ODM 適配",
  "Match product ideas with suitable factories, then keep samples, materials, packaging, and shipment approval under AIWA quality governance.": "將產品構想與合適工廠配對，再由 AIWA 品質治理掌握樣品、材料、包裝與出貨核准。",
  ...
  "AIWA Electronics International Co., Ltd. coordinates brand licensing, OEM/ODM cooperation, and product approval for markets outside Japan and Korea.": "AIWA Electronics International Co., Ltd. 協調日本與韓國以外市場的品牌授權、OEM／ODM 合作與產品核准。",
  "Brand credo": "品牌信念",
